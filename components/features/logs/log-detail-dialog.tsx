      ...
      <DialogContent className="max-w-7xl max-h-[90vh] overflow-hidden">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            <Badge 
              variant={logData.status === "approved" ? "default" : logData.status === "submitted" ? "secondary" : "destructive"}
              className="capitalize"
            >
              {logData.status === "approved" && <IconCircleCheckFilled className="w-3 h-3 mr-1" />}
              {logData.status}
            </Badge>
          </DialogTitle>
          <DialogDescription>
                      ...
                      <Card key={hour.id}>
                        <CardContent className="pt-6">
                          <div className="flex items-center justify-between">
                            <div>
                              <p className="font-medium">{hour.employee.fullName}</p>
                              <p className="text-sm text-muted-foreground capitalize">
                                {hour.department} {hour.isCoCaptain && "• Co-Captain"}
                              </p>
                            </div>
                            <div className="text-right">
                              <p className="text-2xl font-bold">{hour.hours}h</p>
                            </div>
                          </div>
                        </CardContent>
                      </Card>
