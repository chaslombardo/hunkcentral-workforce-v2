...
// Logs Empty States
export const NoLogsEmptyState = React.memo(function NoLogsEmptyState({ onCreateLog }: { onCreateLog?: () => void }) {
...
export const NoLogResultsEmptyState = React.memo(function NoLogResultsEmptyState({ onClearFilters }: { onClearFilters?: () => void }) {
  return (
    <EmptyState
      illustration={
        <React.Suspense fallback={<IllustrationFallback />}>
...
export const NoCommissionsEmptyState = React.memo(function NoCommissionsEmptyState({ onCreateCommission }: { onCreateCommission?: () => void }) {
  return (
    <EmptyState
      illustration={
        <React.Suspense fallback={<IllustrationFallback />}>
...
export const NoCommissionMatchesEmptyState = React.memo(function NoCommissionMatchesEmptyState() {
  return (
    <EmptyState
      icon={TrendingUp}
...
export function NoPayrollDataEmptyState({ onRefresh }: { onRefresh?: () => void }) {
  return (
    <EmptyState
...
export function NoUserResultsEmptyState({ onClearSearch }: { onClearSearch?: () => void }) {
  return (
    <EmptyState
...
export function LoadingEmptyState({ message = "Loading data..." }: { message?: string }) {
  return (
    <EmptyState
      icon={RefreshCw}
      title={message}
