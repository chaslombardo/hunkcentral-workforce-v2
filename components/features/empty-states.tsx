...
// Logs Empty States
export function NoLogsEmptyState({ onCreateLog }: { onCreateLog?: () => void }) {
  return (
    <EmptyState
...
export function NoLogResultsEmptyState({ onClearFilters }: { onClearFilters?: () => void }) {
  return (
    <EmptyState
...
export function NoCommissionsEmptyState({ onCreateCommission }: { onCreateCommission?: () => void }) {
  return (
    <EmptyState
...
export function NoCommissionMatchesEmptyState() {
  return (
    <EmptyState
      icon={TrendingUp}
