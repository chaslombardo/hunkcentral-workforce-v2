    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                Select the sales consultant who booked this job. You can select
                any sales person with commission permissions.
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                Must be unique and match exactly what will be entered in the
                captain&apos;s log. Duplicate job IDs are not allowed.
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
        ...
        <div className="flex gap-4 pt-4">
          ...
          <BrandButton type="submit" variant="primary" loading={isSubmitting}>
            Create Entry
          </BrandButton>
        </div>
      </form>
