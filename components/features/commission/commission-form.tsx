      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-10">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="space-y-3">
                    ...
                    <FormDescription className="text-sm text-muted-foreground">
                      Must be numeric and match the captain&apos;s log entry.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="space-y-3">
                  ...
                  <FormDescription className="text-sm text-muted-foreground">
                    Start typing to reuse a past client or add a new one.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
                    ...
                    <SelectContent>
                      ...
                      >
                        <div className="flex items-center gap-2">
                          <div className="w-2 h-2 rounded-full bg-[#ea7200]" />
                          Junk Removal
                        </div>
                      </SelectItem>
                      <SelectItem
                      ...
                      >
                        <div className="flex items-center gap-2">
                          <div className="w-2 h-2 rounded-full bg-[#026937]" />
                          Moving
                        </div>
                      </SelectItem>
                    </SelectContent>
          ...
          <section className="grid gap-6 md:grid-cols-2">
            ...
            <div className="rounded-xl border border-dashed border-[#026937]/30 bg-[#026937]/5 p-4 text-sm text-muted-foreground">
              <p className="font-medium text-[#026937] mb-1">
                Need to attach documents?
              </p>
              <p>
                Upload supporting files after the entry is created from the
                commission list.
              </p>
            </div>
          </section>

          <div className="flex flex-col gap-4 pt-4 border-t border-border/60 md:flex-row md:items-center">
            <BrandButton
              type="button"
              variant="outline"
              onClick={() => router.back()}
            ...
            <BrandButton
              ...
              className="h-12 w-full md:flex-1 bg-gradient-to-r from-[#026937] to-[#026937]/90 hover:from-[#026937]/90 hover:to-[#026937]"
            >
