...
export interface FormSubmissionToastOptions
  extends Omit<FormToastOptions, 'description'> {
  entityName?: string;
...
export function useFormToast() {
  ...
  const showSubmissionSuccess = React.useCallback(
    (options: FormSubmissionToastOptions) => {
      const entityName = options.entityName || 'form';
      return showSuccess({
        title: options.title || 'Success!',
        description:
          options.description ||
          `Your ${entityName} has been submitted successfully.`,
  ...
  const showSubmissionError = React.useCallback(
    (options: FormSubmissionToastOptions & { onRetry?: () => void }) => {
      const entityName = options.entityName || 'form';
      return showError({
        title: options.title || 'Submission Failed',
        description:
          options.description ||
          `Failed to submit your ${entityName}. Please try again.`,
        duration: options.duration,
  ...
  const showAutoSave = React.useCallback(
    (entityName = 'changes') => {
      return showInfo({
...
export const formToastPresets = {
  ...
  logSubmissionFailed: {
    ...
    description:
      'Unable to submit your log. Please check all fields and try again.',
    entityName: 'log',
  },
  ...
  commissionError: {
    ...
    description:
      'Failed to create commission entry. Please verify the job details.',
    entityName: 'commission',
  },
  ...
  formTips: {
    title: 'Form Tips',
    description:
      'Click the help icon next to any field for additional guidance.',
  },
};
    ...
    async (
      ...
      const loadingToast = formToast.showLoading({
        ...
        description:
          ...
          `Submitting your ${options.entityName || 'form'}...`,
      });
