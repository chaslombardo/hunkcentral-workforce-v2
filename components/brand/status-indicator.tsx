  ...
  "inline-flex items-center gap-1.5 font-medium transition-all duration-200",
  {
    variants: {
      status: {
        ...
        approved: "bg-hunks-green-50 text-hunks-green-700 border-hunks-green-200 dark:bg-hunks-green-950 dark:text-hunks-green-300 dark:border-hunks-green-800",
        matched: "bg-hunks-green-50 text-hunks-green-700 border-hunks-green-200 dark:bg-hunks-green-950 dark:text-hunks-green-300 dark:border-hunks-green-800",
        success: "bg-hunks-green-50 text-hunks-green-700 border-hunks-green-200 dark:bg-hunks-green-950 dark:text-hunks-green-300 dark:border-hunks-green-800",
        completed: "bg-hunks-green-50 text-hunks-green-700 border-hunks-green-200 dark:bg-hunks-green-950 dark:text-hunks-green-300 dark:border-hunks-green-800",
        active: "bg-hunks-green-50 text-hunks-green-700 border-hunks-green-200 dark:bg-hunks-green-950 dark:text-hunks-green-300 dark:border-hunks-green-800",
        ...
        warning: "bg-hunks-orange-50 text-hunks-orange-700 border-hunks-orange-200 dark:bg-hunks-orange-950 dark:text-hunks-orange-300 dark:border-hunks-orange-800",
        processing: "bg-hunks-orange-50 text-hunks-orange-700 border-hunks-orange-200 dark:bg-hunks-orange-950 dark:text-hunks-orange-300 dark:border-hunks-orange-800",
        locked: "bg-hunks-orange-50 text-hunks-orange-700 border-hunks-orange-200 dark:bg-hunks-orange-950 dark:text-hunks-orange-300 dark:border-hunks-orange-800",
        submitted: "bg-hunks-orange-50 text-hunks-orange-700 border-hunks-orange-200 dark:bg-hunks-orange-950 dark:text-hunks-orange-300 dark:border-hunks-orange-800",
        ...
        inactive: "bg-red-50 text-red-700 border-red-200 dark:bg-red-950 dark:text-red-300 dark:border-red-800",
        
        // Neutral states
        draft: "bg-gray-50 text-gray-700 border-gray-200 dark:bg-gray-950 dark:text-gray-300 dark:border-gray-800",
        closed: "bg-gray-50 text-gray-700 border-gray-200 dark:bg-gray-950 dark:text-gray-300 dark:border-gray-800",
...
export function getStatusType(status: string): StatusType {
  ...
  return statusMap[normalizedStatus] || (normalizedStatus in statusIcons ? normalizedStatus : 'info');
}
