      ...
      <CardContent>
        {isOffline && (
          <div className="space-y-3">
            <CardDescription>
              You can continue working offline. Use the &quot;Save Draft&quot;
              button to save your work locally.
            </CardDescription>
            <Alert>
              <AlertCircle className="h-4 w-4" />
              <AlertDescription>
                Some features may be limited while offline. Your drafts will be
...
export function ConnectionQualityIndicator() {
  ...
  return (
    <Alert className="mb-4 border-yellow-500">
      <AlertCircle className="h-4 w-4" />
      <AlertDescription>
        Slow connection detected ({connectionType}). Some features may load
        slowly.
      </AlertDescription>
    </Alert>
  );
