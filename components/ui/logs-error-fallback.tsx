 ...
 */
export function LogsPageErrorFallback({
  error,
  resetError,
}: ErrorFallbackProps) {
  const isAuthError =
 ...
 */
export function LogCreateErrorFallback({
  error,
  resetError,
}: ErrorFallbackProps) {
  return (
      ...
      <Card className="max-w-2xl mx-auto border-yellow-200 bg-yellow-50">
        <CardHeader>
          ...
          <CardDescription className="text-yellow-600">
            Unable to load the log creation form. This might be due to a
            temporary issue.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
 ...
 */
export function LogReviewErrorFallback({
  error,
  resetError,
}: ErrorFallbackProps) {
  const isDatabaseError =
  ...
  return (
    <Card className="border-red-200 bg-red-50">
      ...
      <CardContent className="space-y-4">
        ...
        {isDatabaseError && (
          <div className="text-sm text-red-600 bg-red-100 p-3 rounded border">
            <strong>Database Issue:</strong> The system is temporarily unable to
            connect to the database. Our team has been notified and is working
 ...
 */
export function LogDetailErrorFallback({
  error,
  resetError,
}: ErrorFallbackProps) {
  const isNotFound =
