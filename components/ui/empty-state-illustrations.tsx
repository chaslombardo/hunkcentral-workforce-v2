...
export function UsersIllustration({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <path
        d="M35 55c0-5.5 4.5-10 10-10s10 4.5 10 10"
        stroke={HUNKS_GREEN}
        strokeWidth="2"
        fill="none"
        opacity="0.6"
      ...
      <path
        d="M65 55c0-5.5 4.5-10 10-10s10 4.5 10 10"
        stroke={HUNKS_ORANGE}
        strokeWidth="2"
        fill="none"
        opacity="0.6"
      ...
      <path
        d="M50 85c0-5.5 4.5-10 10-10s10 4.5 10 10"
        stroke={HUNKS_GREEN}
        strokeWidth="2"
        fill="none"
        opacity="0.8"
...
export function WelcomeIllustration({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <path
        d="M60 35v50M35 60h50M45 45l30 30M75 45L45 75"
        stroke={HUNKS_ORANGE}
        strokeWidth="2"
        strokeLinecap="round"
        opacity="0.6"
