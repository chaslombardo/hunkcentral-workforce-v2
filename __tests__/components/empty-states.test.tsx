...
describe('Empty States', () => {
  describe('NoLogsEmptyState', () => {
    it('renders with correct title and description', () => {
      ...
      expect(screen.getByText(/Get started by creating your first daily log/)).toBeInTheDocument()
    })
  ...
  describe('NoCommissionsEmptyState', () => {
    it('renders commission-specific content', () => {
      ...
      expect(screen.getByText('No commissions tracked yet')).toBeInTheDocument()
      expect(screen.getByText(/Start tracking your sales commissions/)).toBeInTheDocument()
    })
  ...
  describe('NoPayrollDataEmptyState', () => {
    it('renders payroll-specific messaging', () => {
      ...
      expect(screen.getByText(/Payroll reports will appear here/)).toBeInTheDocument()
    })
  ...
  describe('NoUsersEmptyState', () => {
    it('renders user management messaging', () => {
      ...
      expect(screen.getByText(/Add team members to get started/)).toBeInTheDocument()
    })
  })
  ...
  describe('NoDashboardDataEmptyState', () => {
    it('renders welcome messaging', () => {
      ...
      expect(screen.getByText(/Your dashboard will show key metrics/)).toBeInTheDocument()
    })
  ...
  describe('Accessibility', () => {
    ...
    it('illustrations have proper alt text', () => {
      ...
      const illustration = screen.getByRole('img', { name: 'Empty logs illustration' })
