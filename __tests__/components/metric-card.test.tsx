...
import {
  ...
  MetricCardSkeleton,
  METRIC_PRESETS,
} from '@/components/brand/metric-card';
...
describe('MetricCard', () => {
  ...
  it('applies correct color variant classes', () => {
    const { container } = render(
      <MetricCard title="Revenue" value="$45,231" color="green" />
    );
  ...
  it('renders loading skeleton when loading prop is true', () => {
    render(<MetricCard title="Revenue" value="$45,231" loading={true} />);
  ...
  it('uses preset configurations correctly', () => {
    render(<MetricCard {...METRIC_PRESETS.revenue} value="$45,231" />);
