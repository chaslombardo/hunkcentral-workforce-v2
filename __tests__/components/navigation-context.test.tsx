...
function TestComponent() {
  ...
  return (
    <div>
      ...
      <div data-testid="is-dashboard-active">{isActiveRoute('/dashboard').toString()}</div>
      <div data-testid="is-dashboard-section">{isActiveSection('dashboard').toString()}</div>
...
describe('NavigationContext', () => {
  ...
  it('provides navigation state and utilities', async () => {
    ...
    expect(screen.getByTestId('is-dashboard-section')).toHaveTextContent('true')
    ...
    expect(global.fetch).toHaveBeenCalledWith('/api/navigation/pending-commissions')
