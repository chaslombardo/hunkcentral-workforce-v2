    ...
    <div className="container mx-auto py-6">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">
          Manage daily work logs, track job progress, and review team activities.
        </p>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 mb-8">
        {canCreateLogs && (
          <Card className="hover:shadow-md transition-shadow">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Create New Log</CardTitle>
              <Plus className="h-4 w-4 text-[#026937]" />
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
                <p className="text-sm text-muted-foreground">
                  Record your daily work activities, jobs completed, and team hours.
                </p>
        ...
        {canReviewLogs && (
          <Card className="hover:shadow-md transition-shadow">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Review Logs</CardTitle>
        ...
        <Card className="hover:shadow-md transition-shadow">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">My Recent Logs</CardTitle>
          ...
          <CardContent className="space-y-3">
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm">Submit logs within 24 hours of work completion</span>
              </div>
              <div className="flex items-center gap-2">
                <Badge variant="outline" className="text-xs">Required</Badge>
                <span className="text-sm">Include all job details and team member hours</span>
              </div>
              <div className="flex items-center gap-2">
                <Badge variant="outline" className="text-xs">Important</Badge>
                <span className="text-sm">Ensure accurate revenue and expense tracking</span>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-3">
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm">Log submitted and awaiting review</span>
              </div>
              <div className="flex items-center gap-2">
                <StatusIndicator status="approved" size="sm" />
                <span className="text-sm">Log approved and processed for payroll</span>
              </div>
              <div className="flex items-center gap-2">
                <StatusIndicator status="rejected" size="sm" />
                <span className="text-sm">Log requires corrections before approval</span>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="mt-6 border-yellow-200 bg-yellow-50">
          ...
          <CardContent>
            <p className="text-yellow-700">
              You currently have view-only access to the logs system. Contact your manager if you need 
              permissions to create or review logs.
            </p>
          </CardContent>
        </Card>
      )}
