          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
            <Card>
              ...
              <CardContent>
                ...
                <div className="flex items-center text-xs text-muted-foreground">
                  ...
                  {formatPercentage(analyticsData.overview.revenueChange)} from
                  last month
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <div className="flex items-center text-xs text-muted-foreground">
                  <TrendingUp className="h-3 w-3 mr-1 text-green-500" />+
                  {formatPercentage(analyticsData.overview.jobsChange)} from
                  last month
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {formatCurrency(analyticsData.overview.avgJobValue)}
                </div>
                <div className="flex items-center text-xs text-muted-foreground">
                  <TrendingDown className="h-3 w-3 mr-1 text-red-500" />
                  {formatPercentage(
                    analyticsData.overview.avgJobValueChange
                  )}{' '}
                  from last month
                </div>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {formatPercentage(analyticsData.overview.laborEfficiency)}
                </div>
                <div className="flex items-center text-xs text-muted-foreground">
                  <TrendingDown className="h-3 w-3 mr-1 text-red-500" />
                  {formatPercentage(
                    analyticsData.overview.laborEfficiencyChange
                  )}{' '}
                  from last month
                </div>
              </CardContent>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <Badge className="bg-[#026937] hover:bg-[#026937]/90">
                        Junk Removal
                      </Badge>
                    </div>
                    <div className="text-right">
                      <div className="font-medium">
                        {formatCurrency(analyticsData.jobTypes.junk.revenue)}
                      </div>
                      <div className="text-sm text-muted-foreground">
                        {analyticsData.jobTypes.junk.count} jobs
                      </div>
                    </div>
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <Badge className="bg-[#ea7200] hover:bg-[#ea7200]/90">
                        Moving
                      </Badge>
                    </div>
                    <div className="text-right">
                      <div className="font-medium">
                        {formatCurrency(analyticsData.jobTypes.move.revenue)}
                      </div>
                      <div className="text-sm text-muted-foreground">
                        {analyticsData.jobTypes.move.count} jobs
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-muted-foreground">
                            {performer.jobs} jobs •{' '}
                            {formatPercentage(performer.efficiency)} efficiency
                          </div>
                        </div>
                      </div>
                      <div className="font-medium">
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Revenue, jobs, and efficiency over the last 6 months
          </CardDescription>
        </CardHeader>
        <CardContent>
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {formatPercentage(commissionStats.avgAccuracy)}
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {commissionStats.pendingEntries}
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {commissionStats.matchedEntries}
            </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Commission performance and booking accuracy trends
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Month-over-month revenue growth over the last 12 months
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Average monthly performance patterns
          </CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <div key={pattern.month} className="p-4 border rounded-lg">
                ...
                <div className="space-y-1">
                  <div className="flex justify-between">
                    ...
                    <span className="text-sm font-medium">
                      ${pattern.avgRevenue.toLocaleString()}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm text-muted-foreground">
