 ...
 */
export function optionalDecimalToNumber(decimal: Decimal | null | undefined): number | undefined {
 ...
 */
export function optionalNumberToDecimal(num: number | null | undefined): Decimal | null {
  if (num === null || num === undefined) return null;
  return new Decimal(num);
}
